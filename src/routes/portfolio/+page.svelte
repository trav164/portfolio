...
<main class="mx-auto sm:w-[600px] w-96 p-6">
	...
	<section class="pt-12">
		...
		<div class="pt-4 text-mid">
			Hi, I'm Lewis. I enjoy keeping up to date with new technology and building side projects to
			improve my quality of life. Currently a software developer at CGI, with a focus on frontend
			development looking for an opportunity to work in a customer-oriented environment delivering
			value in a reliable and scalable form whilst growing into a role and building a career.
		</div>
	</section>
			...
			<div class="flex flex-col w-full">
				<span>
					<a class="underline" href="http://spot-the-intro.lewistravis.co.uk">
						Spot The Intro
						<svg
							class="text-white h-4 mb-1 w-4 inline-block ml-2 underline"
	...
	<section class="pt-12">
		<h3 class="text-light">Buzzwords (Skills)</h3>
	...
	<section class="pt-12">
		...
		<div class="pt-6 flex gap-4 text-light text-sm leading-6">
			...
			<div class="flex flex-col w-full">
				<span class="text-light underline"><a href="https://github.com/trav164">@trav164</a></span>
			</div>
		</div>
		...
		<div class="pt-6 flex gap-4 text-light text-sm leading-6">
			...
			<div class="flex flex-col w-full">
				<span class="text-light underline"
